...
export interface StrategyNFTInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [BytesLike, BytesLike, string, string, string, string, string]
  ): string;
  encodeFunctionData(
...
export interface StrategyNFT extends BaseContract {
  ...
  filters: {
    ...
    "StrategyRegistered(uint256,address,bytes32,bytes32,string,string,string,string)": TypedContractEvent<
      StrategyRegisteredEvent.InputTuple,
      StrategyRegisteredEvent.OutputTuple,
      StrategyRegisteredEvent.OutputObject
    >;
